...
export const translations = {
  th: {
    ...
    portfoliosTitle: "คลังภาพผลงานและกิจกรรม",
    portfoliosSub: "รวบรวมกิจกรรม ความร่วมมือ และความสำเร็จ ที่สะท้อนพลังของชุมชนน้ำน้อยในการสืบสานภูมิปัญญา พัฒนาผลิตภัณฑ์ และสร้างคุณค่าให้ท้องถิ่นอย่างยั่งยืน",
    ...
    meetArtisans: "วิสาหกิจชุมชน กลุ่มผลิตภัณฑ์สมุนไพรไทย",
    artisansSectionTitle: "ทำความรู้จักกับ",
    artisansSectionHighlight: "ประวัติความเป็นมาวิสาหกิจชุมชน",
    artisansSectionBio: "เดิมทีในพื้นที่ตำบลน้ำน้อยมีพืชสมุนไพรพื้นบ้านอยู่หลากหลายชนิดแต่เมื่อพื้นที่เกษตรได้ถูกปรับเปลี่ยนไปตามกาลเวลา ทำให้พืชสมุนไพรหลายชนิดเริ่มสูญหายไปจึงทำให้เกิดแนวคิดที่จะอนุรักษ์พันธุกรรมพืชในท้องถิ่น",
    sustainDirect: "สนับสนุนความยั่งยืน กระจายรายได้สู่ชุมชนโดยตรง 100%",
    featuredArtisanTag: "★ FEATURED PRODUCTS / สินค้าเด่นชุมชน",
    featuredArtisanName: "ผลิตภัณฑ์แปลงใหญ่ชันโรง หมู่ 4",
    featuredArtisanQuote: "“จากคุณค่าของผึ้งชันโรง สู่ผลิตภัณฑ์ชุมชนที่ใส่ใจในทุกขั้นตอน ทั้งน้ำผึ้ง สบู่สมุนไพร และลิปมันไขผึ้ง พร้อมส่งต่อรายได้และความภาคภูมิใจกลับคืนสู่ชุมชนตำบลน้ำน้อย”",
